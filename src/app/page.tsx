...
export const metadata = {
  ...
  description: 'Skapa, studera och dela AI-genererade flashcards. Stöder studieläge, quizläge och tenta-läge.',
}
      ...
      <main className="max-w-3xl mx-auto px-4 py-20 space-y-20">
        ...
        <section className="rounded-3xl border bg-white dark:bg-gray-900 shadow-lg overflow-hidden">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="flex-1 p-8 space-y-4">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                Jag som grundade denna plattform är själv student, och jag vet precis hur det känns när tentaperioden
                närmar sig. Stressen över oändliga PDF-filer, kompendier och föreläsningsanteckningar kan ibland kännas
                övermäktig. Jag insåg att det saknades ett modernt verktyg som faktiskt förstår hur vi studerar idag.
              </p>
            </div>
          </div>
          <div className="border-t bg-violet-50 dark:bg-violet-950/30 px-8 py-6">
            <blockquote className="text-gray-700 dark:text-gray-300 italic leading-relaxed text-base md:text-lg">
              &ldquo;Jag skapade Tentakung för att jag ville bygga det verktyg jag själv saknade: en plats där teknik
              och pedagogik möts för att göra plugget mindre ångestladdat och mer effektivt. Visionen är att ingen
              student ska behöva sitta ensam med sina anteckningar – tillsammans kan vi göra vägen till tentan både
              snabbare och roligare.&rdquo;
            </blockquote>
        ...
        <section className="space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed text-lg">
            Vårt mål är enkelt: att ge alla studenter tillgång till ett gratis och kraftfullt verktyg för att bemästra
            sina kurser. Genom att kombinera smart AI med beprövade inlärningsmetoder gör vi det möjligt att förvandla
            tungt studiematerial till interaktiva flashcards och quiz på bara några sekunder.
          </p>
        </section>
